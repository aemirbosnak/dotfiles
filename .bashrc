...
# Set the PS1 prompt
if [ "$EUID" -eq 0 ]; then
    # You are root, show username in red
    PS1='${debian_chroot:+($debian_chroot)}$RED\u$NO_COLOR@\h:$YELLOW\w$NO_COLOR\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}$GREEN\u$NO_COLOR@\h:$YELLOW\w$NO_COLOR\$ '
fi
